...
from utils import dice_coef, dice_batch, save_images,save_images_p, tqdm_
...
def get_args() -> argparse.Namespace:
    ...
    parser.add_argument("--source_losses", type=str, required=True,
                        help="List of (loss_name, loss_params, bounds_name, bounds_params, fn, weight)")
    parser.add_argument("--source_folders", type=str, required=True,
